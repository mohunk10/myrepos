 ...
 * {@link com.daimajia.slider.library.Indicators.PagerIndicator} and
...
public class SliderLayout extends RelativeLayout {
	...
	/**
	 * {@link com.daimajia.slider.library.Tricks.ViewPagerEx} transformer time
	 * span.
	 */
	...
	/**
	 * Visibility of
	 * {@link com.daimajia.slider.library.Indicators.PagerIndicator}
	 */
	...
	/**
	 * {@link com.daimajia.slider.library.Indicators.PagerIndicator} shape, rect
	 * or oval.
	 */
	...
	public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		mContext = context;
		LayoutInflater.from(context).inflate(R.layout.image_slider_slider_layout, this, true);
	...
	public enum Transformer {
		Default("Default"), Accordion("Accordion"), Background2Foreground("Background2Foreground"), CubeIn("CubeIn"), DepthPage("DepthPage"), Fade("Fade"), FlipHorizontal(
				"FlipHorizontal"), FlipPage("FlipPage"), Foreground2Background("Foreground2Background"), RotateDown("RotateDown"), RotateUp("RotateUp"), Stack(
				"Stack"), Tablet("Tablet"), ZoomIn("ZoomIn"), ZoomOutSlide("ZoomOutSlide"), ZoomOut("ZoomOut");
	 ...
	 * {@link com.daimajia.slider.library.Animations.DescriptionAnimation}
	 * 
	 * @param animation
	 */
	...
	/**
	 * get the {@link com.daimajia.slider.library.Indicators.PagerIndicator}
	...
	public enum PresetIndicators {
		Center_Bottom("Center_Bottom", R.id.default_center_bottom_indicator), Right_Bottom("Right_Bottom", R.id.default_bottom_right_indicator), Left_Bottom(
				"Left_Bottom", R.id.default_bottom_left_indicator), Center_Top("Center_Top", R.id.default_center_top_indicator), Right_Top("Right_Top",
				R.id.default_center_top_right_indicator), Left_Top("Left_Top", R.id.default_center_top_left_indicator);
