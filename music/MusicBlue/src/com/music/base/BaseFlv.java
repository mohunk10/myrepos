...
@SuppressLint("NewApi")
public abstract class BaseFlv<T> extends BaseFragment implements BaseFl<T> {
	...
	private Handler getLVHandler(final ListView lv, final BaseAdapter adapter, final int pageSize) {
		return new Handler() {
